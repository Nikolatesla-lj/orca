...
function ensureNodeRuntime() {
  ...
  // Why: a failed native require can leave Node's module loader in a poisoned
  // state for that binding. Re-check in a fresh process after rebuild so a
  // repaired .node file is loaded from a clean module cache.
