...
const mocks = vi.hoisted(() => ({
  ...
  closeArchitectureTab: vi.fn(),
  createBrowserTab: vi.fn(),
  createArchitectureTab: vi.fn(),
  ...
  setActiveArchitectureTab: vi.fn(),
  setActiveFile: vi.fn(),
  setActiveTab: vi.fn(),
...
function resetStore(): void {
  ...
  storeBox.state = {
    ...
    setActiveArchitectureTab: mocks.setActiveArchitectureTab,
